...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let funcionarios = [
        ...
        nome: 'Carlos Souza',
        cpf: '133',
        salario: 'Casaco fedorento do atanazio para de usar pqp',
...

    {
        ...
        nome: 'Ana Costa',
        cpf: '087',
        salario: 'Joana do Bruno do navarro nao o da sala',
    ...
    function handleFormSubmit(e) {
        ...
        const funcIndex = funcionarios.findIndex(f => String(f.id) === String(id));
